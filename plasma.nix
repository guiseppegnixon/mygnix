{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-bd5eba7b-714e-481a-801c-e896378340cd" = [ ];
      ...
      "kwin"."Window Minimize" = "Meta+H,Meta+PgDown,Minimize Window";
      ...
      "services/brave-browser.desktop"."_launch" = "Meta+Shift+Return";
      "services/btop.desktop"."_launch" = "Meta+Shift+B";
      "services/calibre-gui.desktop"."_launch" = "Meta+Shift+C";
      "services/com.mitchellh.ghostty.desktop"."_launch" = "Meta+Return";
      "services/obsidian.desktop"."_launch" = "Meta+Shift+O";
      "services/org.keepassxc.KeePassXC.desktop"."_launch" = "Meta+Shift+K";
    };
    configFile = {
      ...
      "dolphinrc"."General"."ViewPropsTimestamp" = "2025,8,7,16,57,50.528";
      "dolphinrc"."KFileDialog Settings"."Places Icons Auto-resize" = false;
      "dolphinrc"."KFileDialog Settings"."Places Icons Static Size" = 22;
      "kactivitymanagerdrc"."activities"."bd5eba7b-714e-481a-801c-e896378340cd" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "bd5eba7b-714e-481a-801c-e896378340cd";
...
#      "kscreenlockerrc"."Greeter/Wallpaper/org.kde.image/General"."PreviewImage" = "/home/guiseppe/.local/share/wallpapers/nordic-wallpaper.jpg";
      ...
      "kwinrc"."Desktops"."Id_1" = "d72dd2a2-a7fd-4717-946e-78f441ac0e09";
      "kwinrc"."Desktops"."Id_2" = "5a600a9b-28aa-4aed-bb68-555d8da91368";
      "kwinrc"."Desktops"."Id_3" = "3f2570a5-a6a2-403f-b451-61e2b3c13cbf";
      "kwinrc"."Desktops"."Id_4" = "a7c8938d-90a6-44f2-b450-2d42b97d19b0";
